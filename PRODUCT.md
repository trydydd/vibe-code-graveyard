...
Solo founders, indie hackers, and pre-seed startup teams who built their apps with AI coding tools (Cursor, Claude Code, Bolt.new, Lovable, v0) and are now hitting the wall: scaling crashes, unmaintainable code, security gaps, investor due diligence failures. They're embarrassed but desperate. Secondary audience: agencies and investors who need to assess AI-code risk.
...
- Corporate SaaS landing pages (gradient blobs, trust badges, "book a demo")
- Tech blogs and newsletters (prose-heavy, opinion-first, listicle format)
- Aggressive/shaming content (hate posts, "I told you so" energy)
- Anything that looks like it was built with AI (the irony would be unbearable)
...
- High contrast text (WCAG AA minimum given dark theme)
- Monospace fonts at readable sizes (no tiny terminal text)
- Semantic HTML structure for screen readers
- Reduced motion friendly (no gratuitous animation)
